...
dotnet sln add .\MicroServices\src\Services\Catalog\src\Adesso.Dapr.MicroServices.Catalog.Abstraction\Adesso.Dapr.MicroServices.Catalog.Abstraction.csproj
